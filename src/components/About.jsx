    ...
    <>
      <div className='flex flex-col items-center justify-center  px-6  space-y-8 sm:space-y-6 mt-[100px] md:mt-[300px] '>
        ...
        <div className='flex flex-wrap items-center justify-center gap-2 text-center mt-6 '>
          ...
          <span className='text-blue-400 font-bold text-[36px] sm:text-[50px] md:text-[80px] text-change-animation'>
            {textArray[index]}.
          </span>
        </div>

        {/* Second Section: Roles */}
        <div className='text-green-500 flex flex-wrap items-center justify-center md:gap-6 text-center md:text-lg sm:text-[7px] ml-[-21px] mr-[-5px] mt-[78px]'>
        ...
        <div className='flex justify-center items-center'>
          <a
            ...
            className='relative inline-block bg-green-500 text-white font-bold py-3 px-8 rounded overflow-hidden group mb-0 mt-[70px]'
          >
      ...
      <div className='flex items-center justify-center gap-6 text-center mt-[70px]'>
        {/* GitHub Icon */}
        <a
